...
| 6b | `docs/seo-edgetilt-slots.md` | Brand SEO for **edge tilt slots/poker** … `/slots` (+ bankroll/calcs/calendar/logbook), `/guides`, `/poker` (+ bankroll/stable), sitemap, Search Console |
