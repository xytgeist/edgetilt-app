# Enforcer (Ainsworth) — advantage play notes (stub)

_Generated seed — edit freely. Sync to Supabase with `npm run slots:sync` when ready._

## What you are hunting

Enforcer (Ainsworth) is catalogued as **Must-Hit-By** (Ainsworth). Edge lives where **state on the glass** lines up with **correct denom / bet qualification** and **fresh paytable truth** for this bank.
