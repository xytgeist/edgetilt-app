...
Look for **high Lightning counters**, adjusted for bet level and denomination. 

Use your Phoenix Link calculator for precise take points. Lower bets on low denoms (88% RTP range) usually need **high 1400s**, while higher bets on higher denoms (92-93% RTP) can be playable in the **high 1200s**.

![Lightning 10 Year Storm counter: free feature must be won before 1888 collected](/guides/lightning-10-year-storm/counter.webp)

## 🛑 When to stop

Play until the counter bonus triggers. Do not chase **low counters** on **poor RTP setups**. Make sure to check the counter after hitting the counter bonus - unlike Buffalo Link, the counter resets to a random number and may reset back to a +EV point. I've seen resets into the high 1400s multiple times.
...
**Bankroll on hand: 400 units** (depends heavily on bet size and target counter)
...
**Lightning 10 Year Storm** is a **5-reel, up to 100-line** (or ways) video slot by Aristocrat (released in 2024) built around a **Must-Hit-By Lightning Counter** that drives the advantage play opportunity.

Every **Lightning symbol** that lands (in base game or during bonuses) increments the visible counter by 1. The counter has a **must-hit-by of 1888**, but it can trigger randomly at any time before then. When it triggers, you enter a **Hold & Spin** feature where Lightning symbols lock in place with credit values, and/or multiple Mini/Minor Bonuses, multiple Major Jackpots, and of course the ever-elusive Grand Jackpot.

The counter is **fully persistent and bet-specific** - each denomination and bet level has its own independent counter. This is why checking every bet level is critical.

Additional features include:
- **Hold & Spin** with chances for Mini/Minor/Major/Grand jackpots (Mini/Minor Bonuses and Major Jackpot scale by denom)
