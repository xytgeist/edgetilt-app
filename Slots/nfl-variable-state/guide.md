# NFL Variable State Slot — advantage play notes (stub)

_Generated seed — edit freely. Sync to Supabase with `npm run slots:sync` when ready._

## What you are hunting

NFL Variable State Slot is catalogued as **Persistent State** (Various). Edge lives where **state on the glass** lines up with **correct denom / bet qualification** and **fresh paytable truth** for this bank.
...
Nerf risk **High**: assume paytables, caps, and marketing can move without notice.
