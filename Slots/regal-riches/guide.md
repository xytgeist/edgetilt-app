# Regal Riches — advantage play notes (stub)

_Generated seed — edit freely. Sync to Supabase with `npm run slots:sync` when ready._

## What you are hunting

Regal Riches is catalogued as **Persistent State** (IGT). Edge lives where **state on the glass** lines up with **correct denom / bet qualification** and **fresh paytable truth** for this bank.
