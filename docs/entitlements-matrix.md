...
| 2026-09-05 | **IPA paywall shows IAP list only.** StoreKit `displayPrice` or ASC points (Starter `$22.99`/`$254.99`, Pro `$68.99`/`$759.99`, Edge Pro `$11.49`). Web/founding/military/affiliate stickers stay on Safari/Stripe. Lifetime has no hardcoded IAP fallback until higher points. |
