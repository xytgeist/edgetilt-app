...
| W-2G extract keyboard pill | Web | **2026-09-12:** IPA hides the WK Done / prev-next bar. Tax field focus on the extract / verify list shows a hover pill (prev / next / Done → `dismissEdgeKeyboard`). Safari / PWA keep the system accessory … pill is shell-only. |
