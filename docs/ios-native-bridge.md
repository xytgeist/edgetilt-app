...
4. **Continue Mac P0:** ~~APNs bridge + `setAudioSession`~~ **landed 2026-08-24** (token after Individual membership activates + Push entitlement). ~~Safe area / Island pad / unmute handoff~~ **Ryan device sign-off 2026-08-25.** ~~OAuth-in-shell~~ **Ryan sign-off 2026-08-25** (Google stayed in WKWebView). Remaining: hard-crash repro leaving post detail. ~~Lounge GIF picker keyboard~~ **Ryan smoke PASSED 2026-08-25** (IPA + web).
