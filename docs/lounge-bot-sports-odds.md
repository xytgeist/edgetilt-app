...
- **Hammers:** unanimous house ATS (Scott / Rocco / Chedda / Tank spot). Header is `## 🔥 Hammers`. Game badge is `🔥 {n}-0 Hammer`. Same layout as Consensus … `### {away}/{home} · {when}` then `· **[gold]{pick}[/gold]**`
