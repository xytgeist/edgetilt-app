...
- **2026-08-01:** Player stake history on Bankroll: On Stake session list interleaves text rows for offer, Edge accept, re-up, and settle (`pokerStableDealHistory.js`).
