...
- **2026-08-06:** **Stable light mode palette:** matches Slots/Poker bankroll (zinc surfaces + blue `#2563eb` chrome + emerald money). Dark mode still uses cyan JSX tokens (`pokerStableUi.js`).
