...
- **2026-08-01:** Stake accent palette: heroes rotate **blue / emerald / rose** (oldest deal = blue). Light mode: flat white card + neutral elevation; tone on border, title, badge (no gradient 3D shell).
