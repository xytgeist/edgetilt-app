...
- **2026-08-06:** **Stable dark mode palette:** matches Slots bankroll (zinc `from-zinc-900`/`to-zinc-800` cards + `border-zinc-700/40` + white amounts; cyan kept for primary CTAs/tabs via `pokerStableUi.js`).
