...
- **2026-08-01:** Stake accent palette: heroes rotate **blue / emerald / rose** (oldest deal = blue). Light mode: tone gradient + neutral elevation shadow; no inset highlight or colored 3D shell.
