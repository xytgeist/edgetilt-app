...
- **2026-08-12:** **Player ARCHIVE close review (client):** archived Bankroll cards + detail show the same closed-stake economics as the pre-archive review (per-backer returned / owed) via **`PokerStakeeClosedStakeReviewSections`**.
