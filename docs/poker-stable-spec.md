...
- **2026-08-07:** **Backing bankroll pencil adjust (client):** portfolio hero pencil beside **Backing bankroll** opens Add/Remove (liquid only). Deposit/withdraw RPCs unchanged.
