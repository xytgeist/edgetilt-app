...
- [ ] **Play Logbook (if prod ships Logbook):** apply test-validated chain through **`20260907240000_play_log_ledger_decline_settlement.sql`** — base **`20260529120000_play_logbook.sql`**, shared sessions **`20260531140000`**, manager/paid **`20260531190000`**, paid/unpaid notify repair order (**`20260531300000`** → **`20260531310000`**, repair **`20260531320000`** if needed), custom metrics **`20260531350000`**, admin primary templates **`20260531400000`**, MHB fields **`20260531500000`**, label migrations **`20260531330000`**–**`20260531360000`**, **`20260531510000`**–**`20260531530000`**, **`20260531540000`**, shared template **`20260907210000`**, ledger Settle All history **`20260907220000`**, ledger independent-books Alert **`20260907230000`**, Remain Unsettled **`20260907240000`**. Redeploy **`lounge-send-activity-push`** after activity-event migrations.
