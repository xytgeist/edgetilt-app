...
- [ ] **Delete account GoTrue grants + swap SET NULL (2026-09-15):** **Not applied on prod.** SQL **`20260915160000`** (auth_admin grants) then **`20260915170000`** (swap counterparty → guest on user delete + **`explain_auth_user_delete_block`**). Redeploy **`delete-own-account`**. Wait for Ryan.
