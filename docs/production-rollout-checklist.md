...
- [ ] **Backing Bankroll loan display (2026-09-16):** frontend **`1.4.277`** on **`test`**. Auto top-up loans stay off Backing Bankroll / Portfolio. **No SQL / Edge.** Promote with `test` → `main` when Ryan asks.
