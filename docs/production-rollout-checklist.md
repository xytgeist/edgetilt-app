...
_Last updated: **2026-07-07** — bot Post as images (**`20260707000000`**), X manual transform (**`lounge-x-ingest`**), **`schema_migrations`** through **`20260707000000`**, Scott **`poll_live`** (**`20260706190000`**). Prior: bot portal reply SQL (**`20260704220000`**), client **`48d739db`**. Frontend: `docs/frontend-architecture.md`; test tracking: `docs/test-buildout-backlog.md`._
