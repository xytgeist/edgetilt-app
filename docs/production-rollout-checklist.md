...
- [ ] **Delete account GoTrue grants + swap/stake preserve (2026-09-15):** **Not applied on prod.** SQL **`20260915160000`** (auth_admin grants), **`20260915170000`** (swap → guest), **`20260915180000`** (stake deal/slice SET NULL + guest). Redeploy **`delete-own-account`**. Wait for Ryan.
