...
- [x] **IPA Lifetime card (2026-09-14):** Apple approved higher price points. Subscribe carousel is Starter + Pro + Lifetime on the shell (`1.4.210`). ASC Lifetime IAP `6809032089` priced **`$1,999.00`** US. Still Prepare for Submission. Do not attach it to the Waiting for Review **1.4.95 (125)** listing.
