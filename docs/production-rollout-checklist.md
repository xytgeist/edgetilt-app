...
- [ ] **Poker multi-flight series watermark (test only until Ryan asks):** apply **`20260814170000_poker_tournament_swap_series_watermark.sql`** on prod before promoting the client. **No Edge redeploy.** Smoke: Day 1B then Day 1C same name/venue/buy-in shows prior bullets; new swap defaults this-bullet-forward; 1B swap still listed on 1C; Day 1 bust leaves swap open.
