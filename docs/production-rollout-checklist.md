...
- [ ] **Delete account GoTrue grants + swap/stake preserve (2026-09-15):** **Not applied on prod.** SQL **`20260915160000`** (auth_admin grants), **`20260915170000`** (swap → guest), **`20260915180000`** (stake SET NULL + guest), **`20260915190000`** (keep **`Name (Deleted User)`**). Redeploy **`delete-own-account`**. Wait for Ryan.
