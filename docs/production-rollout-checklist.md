...
- [x] **Open swaps on Bankroll (2026-09-16):** frontend **`1.4.254`** via **`test` → `main`**. **Open swaps** list on Poker Bankroll. Tap opens session card or standalone sheet. Redeployed **`poker-tournament-swap-notify`** (`kind=nudge`) test + prod.
