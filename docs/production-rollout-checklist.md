...
- [ ] **Gmail-dot swap claim + cancelled invite (2026-09-16):** SQL **`20260917120000`** on **test**. Frontend **`1.4.262`** on **`test`**. Apply SQL on **prod** when Ryan asks. **No Edge redeploy.**
