...
- [x] **Store-screenshot hide (2026-09-07, `main` @ `51561730`):** cherry-pick only, not a full `test` FF. AP Guide card Delete + Slots Edge lock, Play Logbook **Primary game templates** off. **No SQL / Edge.** Wait for Vercel **edgetilt.com**. Full FF still blocked: **`20260906120000`** `has_edge_pro` is test-only.
