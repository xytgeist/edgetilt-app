...
_Last updated: **2026-07-30** — Poker tournament swaps promote (SQL **`20260730140000`–`180000`**, Edge **`poker-tournament-swap-notify`** + **`lounge-send-activity-push`**, client **`main` @ `5bde2e48`**). Handoff: root **`WAKEUP`**. Open ops: confirm prod **`PUBLIC_APP_URL`** + Twilio From for guest SMS. Earlier **2026-07-29**: Casino LV geo gaps **`20260730120000`**; Poker Bankroll Manager chain. Prior **2026-07-25**: Lounge staged video (`3f48b328`)._
