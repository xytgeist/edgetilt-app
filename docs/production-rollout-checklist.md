...
- [ ] **Lounge UGC reports (2026-09-11):** apply **`20260911130000_lounge_ugc_reports.sql`** on **prod** (Dashboard SQL Editor or `pg`, not `db:query -f` … multi-statement). Record version. Frontend is **`1.4.173`** on `test`. Needed before App Review recording on **edgetilt.com**. No Edge deploy.
