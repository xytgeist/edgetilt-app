...
- [ ] **Multi-guest text invite share sheet (2026-09-16):** frontend **`1.4.261`** on **`test`**. Share sheet stays open until each guest is shared. **No SQL / Edge.** Promote with next **`test` → `main`**.
