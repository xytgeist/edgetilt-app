...
- [ ] **Tournament picker dates + Edge avatars (2026-09-16):** frontend **`1.4.267`** on **`test`**. Start Session labels include the date. Partner / +Edge user picker shows avatars (guests stay text-only). **No SQL / Edge.**
