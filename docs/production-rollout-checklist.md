...
_Last updated: **2026-07-29** — Casino LV geo gaps SQL **`20260730120000`** on prod (Horseshoe Las Vegas + Strip fills). Earlier: Poker Bankroll follow-up **`main` @ `6c055e17`**; Poker Bankroll Manager SQL **`20260729000000`–`20260730030000`**. Prior **2026-07-25**: Lounge staged video (`3f48b328`)._
