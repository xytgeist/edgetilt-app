...
- [x] **IPA Lifetime card (2026-09-14):** Apple approved higher price points. Subscribe carousel is Starter + Pro + Lifetime on the shell (`1.4.210`). Frontend only. Confirm ASC Lifetime IAP is Cleared for Sale. Do not attach a new binary to the Waiting for Review listing.
