...
- [ ] **Slots Edge Pro + Lifetime grant Edge Pro (2026-09-07):** apply **`20260906120000`** then **`20260907120000`** on **`jtjgtucumuoswnbauxry`**. Frontend on **`test`** @ **`1.4.95`**. Do not FF `main` until both SQL files are on prod. Starter stays out.
- [x] **Store-screenshot hide (2026-09-07, `main` @ `51561730`):** cherry-pick only, not a full `test` FF. AP Guide card Delete + Slots Edge lock, Play Logbook **Primary game templates** off. **No SQL / Edge.** Wait for Vercel **edgetilt.com**. Full FF blocked until **`20260906120000`** + **`20260907120000`** are on prod.
