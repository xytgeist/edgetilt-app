...
- [ ] **Delete account GoTrue grants + swap/stake preserve (2026-09-15):** **Not applied on prod.** SQL **`20260915160000`** through **`20260915200000`** (grants, swap/stake guest preserve, **`Name (Deleted User)`**, `label` ambiguous fix). Redeploy **`delete-own-account`**. Wait for Ryan.
