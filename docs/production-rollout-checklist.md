...
- [x] **Poker swap Min cash term (2026-08-15 promote):** applied **`20260815120000`** on **`jtjgtucumuoswnbauxry`**. **No Edge redeploy.** Frontend via **`test` → `main`**. Smoke: threshold met by one side settles; neither hits → $0; exact threshold activates; label shows **Min cash $…**.
