...
- [ ] **Sell Action guest text invite (2026-09-16):** SQL **`20260917220000`** on **test**. Frontend **`1.4.268`** on **`test`**. Apply mint-active-slice SQL on **prod** when Ryan asks. **No Edge redeploy.**
