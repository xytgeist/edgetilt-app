...
- 2026-05-29: **Play Logbook — EV ($) field:** migration **`20260531520000_play_log_ev_usd_label.sql`**; metric **`expected_ev_usd`** label **EV ($)**; calculator prefill no longer duplicates EV in notes (form field only).
