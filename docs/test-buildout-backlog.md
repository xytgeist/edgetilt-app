...
- 2026-05-19: **R2 Cache-Control:** uploads + migration PUT **`public, max-age=31536000, immutable`**; **`lounge-cf-r2-backfill-cache-control`** backfilled **69** objects on test. CORS must allow **`Cache-Control`** header on bucket.
