...
- **On-device OCR:** `EdgeNative.recognizeText` → Vision. W-2G extract on a current IPA. Starter+ cloud only when the six fields look unsure. Simulator works. Old IPA / PWA stay on tesseract.
