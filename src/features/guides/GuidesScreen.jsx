...
function GuideLockedPaywallOverlay({ onUnlock, upgradeMode = false }) {
  return (
      ...
      <div className="relative z-10 flex max-w-[16rem] flex-col items-center gap-3 text-center">
        ...
        <div>
          ...
          <p className="mt-1 text-xs leading-snug text-zinc-300 drop-shadow-[0_1px_6px_rgba(0,0,0,0.8)]">
            {upgradeMode
              ? 'Upgrade to unlock this playbook and the rest of AP Guides.'
        ...
        <button
          ...
          className={
            upgradeMode
              ? 'min-h-11 w-full max-w-[13rem] rounded-2xl bg-cyan-500 px-4 text-sm font-bold text-zinc-950 touch-manipulation hover:bg-cyan-400 active:scale-[0.98] shadow-[0_0_24px_rgba(6,182,212,0.22)]'
              : 'min-h-11 w-full max-w-[13rem] rounded-2xl bg-amber-500 px-4 text-sm font-bold text-zinc-950 touch-manipulation hover:bg-amber-400 active:scale-[0.98] shadow-[0_0_24px_rgba(255,234,0,0.2)]'
          }
        >
          {upgradeMode ? 'Upgrade' : 'See plans'}
        </button>
      </div>
    </div>
  )
                  ...
                  <div className="relative">
                    ...
                    {guideLockedCollapsed ? (
                      <GuideLockedPaywallOverlay
                        upgradeMode={hasSlotsEdgeStarter && !hasSlotsEdge}
