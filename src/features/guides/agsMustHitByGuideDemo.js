...
Hero art for this card is sourced from **Slots/ags-must-hit-by/hero.webp** in your repo (bundled fallback: **/guides/ags-must-hit-by/hero.webp** in the app **public** folder).
