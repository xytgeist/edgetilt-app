...
export const ainsworthMustHitByCardBullets = [
  '**Ainsworth-style** mystery MHBs: the machine picks a **secret hit value uniformly** between the **reset** and **must-hit-by cap**; **meter rise** is a **% of coin-in** until the meter crosses that point ([Wizard of Odds](https://wizardofodds.com/games/slots/mystery-jackpot-ainsworth/)).',
  '**Example (Red Rock, 2013 sample on WOO):** Minor **$20 → $50** with **~0.45%** of bet to the meter; Major **$350 → $400** with **~0.20%** — **your** casino’s glass can differ; always re-verify.',
  '**Do not** treat **AGS** must-hit-by the same way — WOO notes those can **rarely trigger until very near the cap**; the uniform model here is for **Ainsworth-style** behavior.',
]
