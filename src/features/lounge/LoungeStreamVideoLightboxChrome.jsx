...
/** Image/GIF lightbox top chrome - light frost ovals. */
export const LOUNGE_IMAGE_LIGHTBOX_TOP_BTN_CLASS =
  'flex h-9 w-11 shrink-0 touch-manipulation items-center justify-center rounded-full bg-white/25 text-white shadow-none backdrop-blur-xl hover:bg-white/35 active:bg-white/40 [-webkit-tap-highlight-color:transparent]'
...
export const LOUNGE_IMAGE_LIGHTBOX_TOP_FOLLOW_BTN_CLASS =
  'media-lightbox-nav-btn flex h-9 shrink-0 touch-manipulation items-center justify-center rounded-full bg-white/25 px-4 text-[13px] font-bold text-white shadow-none backdrop-blur-xl hover:bg-white/35 active:bg-white/40 [-webkit-tap-highlight-color:transparent]'
