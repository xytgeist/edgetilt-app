...
export const LOUNGE_HERO_LIGHTBOX_TOP_BTN_CLASS =
  'flex h-10 w-10 shrink-0 touch-manipulation items-center justify-center rounded-full border-0 bg-white/25 text-white shadow-sm backdrop-blur-xl hover:bg-white/35 active:bg-white/40 [-webkit-tap-highlight-color:transparent]'
...
export const LOUNGE_IMAGE_LIGHTBOX_TOP_BTN_CLASS =
  'flex h-9 w-11 shrink-0 touch-manipulation items-center justify-center rounded-full border-0 bg-white/25 text-white shadow-sm backdrop-blur-xl hover:bg-white/35 active:bg-white/40 [-webkit-tap-highlight-color:transparent]'
...
export const LOUNGE_IMAGE_LIGHTBOX_TOP_FOLLOW_BTN_CLASS =
  'media-lightbox-nav-btn flex h-9 shrink-0 touch-manipulation items-center justify-center rounded-full border-0 bg-white/25 px-4 text-[13px] font-bold text-white shadow-sm backdrop-blur-xl hover:bg-white/35 active:bg-white/40 [-webkit-tap-highlight-color:transparent]'
...
export const LOUNGE_HERO_LIGHTBOX_TOP_FOLLOW_BTN_CLASS =
  'flex h-10 shrink-0 touch-manipulation items-center justify-center rounded-full border-0 bg-white/25 px-3.5 text-[13px] font-bold text-white shadow-sm backdrop-blur-xl hover:bg-white/35 active:bg-white/40 [-webkit-tap-highlight-color:transparent]'

/** Portrait author-row Follow - aligned with display name / handle. */
export const LOUNGE_HERO_LIGHTBOX_AUTHOR_FOLLOW_BTN_CLASS =
  'shrink-0 rounded-full border-0 bg-white/25 px-3.5 py-1.5 text-[13px] font-bold text-white shadow-sm backdrop-blur-xl hover:bg-white/35 active:bg-white/40 touch-manipulation [-webkit-tap-highlight-color:transparent]'
