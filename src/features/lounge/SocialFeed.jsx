...
export default function SocialFeed({
  ...
  const openLoungePostDetail = useCallback(
    ...
    [cancelLoungeDetailEditMediaPrep, composerUserId, loungeReadOnly, onRequireAuth, profileModalOpen, profileOverlayStack.length, refreshLoungePostInteractions]
  )
  ...
  const onLoungePostUploadSaveDraft = useCallback(() => {
    ...
    setLoungePostUploadFailedOpen(false)
    setLoungePostUploadFailureDetails(null)
  }, [cancelQuoteRepostMediaPrep, composerMediaUrl, disposeComposerVideoMedia, loungePostDetail?.id, postText, restoreQuoteFromSnapshot])
                      ...
                      >
                        <div className="relative h-20 bg-gradient-to-br from-amber-950/60 to-zinc-900 overflow-hidden">
                          ...
                          <div className="absolute bottom-0 inset-x-0 px-2.5 pb-2 flex flex-col items-start gap-1">
                            <p className="text-white font-bold text-xs leading-tight truncate w-full">{loungePostDetail.reposted_post.game_title}</p>
                      ...
                      >
                        <div className="relative h-28 bg-gradient-to-br from-amber-950/60 to-zinc-900 overflow-hidden">
                          ...
                          <div className="absolute bottom-0 inset-x-0 px-3 pb-2.5 flex flex-col items-start gap-1">
                            <p className="text-white font-bold text-sm leading-tight truncate w-full">{loungePostDetail.game_title}</p>
