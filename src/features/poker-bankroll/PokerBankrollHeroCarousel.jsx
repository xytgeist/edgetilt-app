  ...
  const themes = [
    {
      ...
      editBtn: 'bg-indigo-500 text-white active:bg-indigo-400',
    ...
    },
    {
      ...
      editBtn: 'bg-orange-500 text-white active:bg-orange-400',
    ...
    },
    {
      ...
      amount: 'text-rose-50',
      editBtn: 'bg-rose-500 text-white active:bg-rose-400',
