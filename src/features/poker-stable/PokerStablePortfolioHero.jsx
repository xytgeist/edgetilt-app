        ...
        <div className="grid grid-cols-2 gap-3 text-center">
          <div>
            ...
            <div className="mt-1">
              ...
              {pendingHold > 0 ? (
                <div
                  className="mt-0.5 text-xs font-semibold tabular-nums text-zinc-400"
          ...
          >
            ...
            <div className="space-y-4 overflow-y-auto px-5 py-4">
              ...
              <HeroInfoSection title="Top numbers">
                <p>
                  <strong className="font-semibold text-zinc-300">Backing bankroll</strong> ... settle/close-out
                  economics and stake deployments, minus capital on{' '}
              ...
              <HeroInfoSection title="Metrics">
                ...
                <p>
                  <strong className="font-semibold text-zinc-300">TWR</strong> ... time-weighted return on your backing
                  pool. Horse performance $ inside each period. Not the same as At-risk ROI.
                </p>
                <p>
