...
export const STABLE_PRIMARY_BTN =
  'bg-cyan-600 text-white touch-manipulation active:bg-cyan-500'

export const STABLE_TAB_ACTIVE = 'bg-cyan-600 text-white'

export const STABLE_ACCENT_TEXT = 'text-cyan-300'

export const STABLE_CHART_PORTFOLIO = '#22d3ee'
