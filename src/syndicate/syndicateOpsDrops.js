...
export const OPS_DROPS = [
  ...
  },
  {
    ...
    destKind: 'slate',
    hint: 'NFL Friday 1pm is a lean, not a lock. CFB Friday noon stays the house lock.',
    info: 'The scheduled / full-board shop card. NFL Friday 1pm PT is a lean / watch list. Saturday steam confirms or kills. Sunday inactives lock the early (1pm ET) and late (4pm ET) windows. CFB Friday noon stays the house lock. Same 4-desk layout as Picks for today.',
  },
  {
    id: 'ufc_slate',
    label: 'UFC slate',
    ...
    info: 'Active UFC board / main card, not limited to fights kicking today. Cron and default Send to: public tease + fan-only uncut + VIP chat + X (the public tease). Use Picks for today when you only want tonight\'s card.',
  },
  {
    id: 'solo',
    label: 'Solo / spot',
  ...
  },
  {
    ...
    sports: [OPS_SPORT_NFL],
    destKind: 'wong',
    hint: 'Sat 7pm PT. Confirm or kill Friday Sunday leans after Saturday steam.',
    info: 'Saturday steam check on the Friday NFL lean. Always posts. STANDS or KILL if the number walked 1.5+ or a listed starter shock hit. Still a lean. Official lock is Sunday inactives. Public Lounge + VIP chat.',
  },
  {
    id: 'sunday_early_lock',
    label: 'Sunday early lock',
    sports: [OPS_SPORT_NFL],
    destKind: 'wong',
    hint: '~8:30am PT. Lock 1pm ET window on 90-min inactives.',
    info: 'Locks Friday leans for Sunday games kicking before 1pm PT (the 1pm ET cluster). Same kill rule as primetime: listed starter out or number walked 1.5+. Cron waits for the 70-110 min window. Preview / Publish can run anytime.',
  },
  {
    id: 'sunday_late_lock',
    label: 'Sunday late lock',
    sports: [OPS_SPORT_NFL],
    destKind: 'wong',
    hint: '~11:30am PT. Lock 4:05/4:25 ET window on 90-min inactives.',
    info: 'Locks Friday leans for Sunday games kicking 1pm–4pm PT (4:05 / 4:25 ET). SNF stays on Primetime lock. Cron waits for the 70-110 min window. Preview / Publish can run anytime.',
  },
  {
    id: 'wong',
    label: 'Wong teaser',
