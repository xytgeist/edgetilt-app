...
export const OPS_WEEK_TASKS = [
  {
    ...
    label: 'MNF spotlight',
    atLabel: '2:00pm',
    detail: 'Mon 2:00pm PT lean. Morning steam is in. Friday house lean is not the MNF lock. Official lock is 90-min inactives (~3:45pm for a 5:15 PT kick).',
    days: [1],
    startHour: 14,
    endHour: 16.5,
    tab: 'scorecard',
  ...
  },
  {
    ...
    label: 'MNF lock',
    atLabel: '90m pre',
    detail: 'Mon ~90 min before kick. Confirm the lean or kill on inactives / number walk.',
    days: [1],
    startHour: 15.5,
    endHour: 19,
    tab: 'scorecard',
  ...
  },
  {
    ...
    kind: 'check',
    label: 'UFC metrics',
    detail: 'Tuesday sync writes a what-changed dump on UFC Metrics. New names and career moves. Overrides stay put.',
    days: [2],
    startHour: 9,
    endHour: 18,
    tab: 'ufc_metrics',
  ...
  },
  {
    ...
    label: 'TNF public',
    atLabel: '3:30pm',
    detail: 'Thu 3:30pm PT. Public 4-desk TNF card + VIP chat + X if a game is on.',
    days: [4],
    startHour: 15.5,
    endHour: 18,
    tab: 'scorecard',
  ...
  },
  {
    ...
    label: 'TNF lock',
    atLabel: '90m pre',
    detail: 'Thu ~90 min before kick. Confirm the lean or kill on inactives / number walk.',
    days: [4],
    startHour: 15.5,
    endHour: 19,
    tab: 'scorecard',
  ...
  },
  {
    ...
    label: 'House lean',
    atLabel: '1:00pm',
    detail: 'Fri 1:00pm PT NFL lean. Not a lock. Paste splits first.',
    days: [5],
    startHour: 13,
    endHour: 15,
    tab: 'scorecard',
  ...
  },
  {
    ...
    label: 'Sat steam',
    atLabel: '7:00pm',
    detail: 'Sat 7:00pm PT. Confirm or kill Friday Sunday leans after Saturday steam.',
    days: [6],
    startHour: 18,
    endHour: 22,
    tab: 'scorecard',
  ...
  },
  {
    ...
    label: 'Early lock',
    atLabel: '8:30am',
    detail: 'Sun ~8:30am PT. Lock 1pm ET window on 90-min inactives.',
    days: [0],
    startHour: 8,
    endHour: 11,
    tab: 'scorecard',
  ...
  },
  {
    ...
    label: 'Late lock',
    atLabel: '11:30am',
    detail: 'Sun ~11:30am PT. Lock 4:05/4:25 ET window on 90-min inactives.',
    days: [0],
    startHour: 11,
    endHour: 14,
    tab: 'scorecard',
  ...
  },
  {
    ...
    label: 'SNF spotlight',
    atLabel: '3:30pm',
    detail: 'Sun 3:30pm PT. Public 4-desk SNF card + VIP chat + X if a game is on.',
    days: [0],
    startHour: 15.5,
    endHour: 18,
    tab: 'scorecard',
  ...
  },
  {
    ...
    label: 'SNF lock',
    atLabel: '90m pre',
    detail: 'Sun ~90 min before kick. Confirm the lean or kill on inactives / number walk.',
    days: [0],
    startHour: 15.5,
    endHour: 19,
    tab: 'scorecard',
