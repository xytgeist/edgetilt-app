...
export const OPS_WEEK_TASKS = [
  {
    ...
    label: 'MNF spotlight',
    atLabel: '3:30pm',
    detail: 'Mon 3:30pm PT. Public 4-desk MNF card + VIP chat if a game is on.',
    days: [1],
    startHour: 15.5,
    endHour: 18,
    tab: 'scorecard',
  ...
  },
  {
    ...
    label: 'TNF public',
    atLabel: '3:30pm',
    detail: 'Thu 3:30pm PT. Public 4-desk TNF card + VIP chat if a game is on.',
    days: [4],
    startHour: 15.5,
    endHour: 18,
    tab: 'scorecard',
  ...
  },
  {
    ...
    label: 'SNF spotlight',
    atLabel: '3:30pm',
    detail: 'Sun 3:30pm PT. Public 4-desk SNF card + VIP chat if a game is on.',
    days: [0],
    startHour: 15.5,
    endHour: 18,
    tab: 'scorecard',
