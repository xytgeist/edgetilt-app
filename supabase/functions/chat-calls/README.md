...
| `CHAT_CALL_EGRESS_USE_CUSTOM` | Set `0` to force LiveKit built-in `speaker` layout. Default **on** (custom pin template at `CHAT_CALL_EGRESS_TEMPLATE_BASE_URL` / project default). |
