-- Edge Monitor: drop Market symbol bulk sync from scheduled job registry.
-- Cron is intentionally unscheduled (20260723290000); on-demand via invoke_lounge_market_symbol_sync() only.
