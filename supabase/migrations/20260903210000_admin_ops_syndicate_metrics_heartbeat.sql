-- Edge Monitor: register Syndicate NFL/CFB/UFC metrics GHA sync (Tue 14:00 UTC → prod).
-- Heartbeats via admin_ops_record_job_heartbeat from GitHub Actions after sync-production.
...
comment on function public.admin_ops_scheduled_jobs_snapshot() is
  'Admin Edge Monitor: pg_cron + external heartbeats (poker catalog + syndicate metrics GHA).';
